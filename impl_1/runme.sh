...
HD_PWD='C:/Users/OAkun/Desktop/School/CECS361/ZyboBreakoutScoreCalc/ZyboBreakoutScoreCalc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboBreakoutScoreCalc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboBreakoutScoreCalc_wrapper.tcl -notrace
